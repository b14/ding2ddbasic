  ...
  <div class="left">  
    ...
    <div class="field field-name-field-ding-event-target field-label-inline clearfix">
      ...
      <div class="field-items">
        <div class="field-item even"><?php print $time_begin . " " . t('to') . " " .  $time_end; ?></div>
      </div>
    </div>
    <?php print render($content['group_left']['field_ding_event_price']); ?>
...
<!--
    <div class="section meta">
      <div class="author"><?php print t("Af"); ?> <?php print $name; ?></div>
